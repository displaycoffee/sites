<?php
	...
	function insprvw_create_movie_review() {
		$labels = array(
			'name'               => __( 'Movie Reviews', 'inspire-reviews' ),
			'singular_name'      => __( 'Movie Review', 'inspire-reviews' ),
			...
			'menu_name'          => __( 'Movie Reviews', 'inspire-reviews' ),
			'update_item'        => __( 'Update Reviews', 'inspire-reviews' ),
			'not_found'          => __( 'No reviews found.', 'inspire-reviews' )
		);

		$args = array(
			'label'               => __( 'Movie Review', 'inspire-reviews' ),
			'labels'              => $labels,
		...
		register_post_type( 'insprvw-movie-review', $args );
	}

	add_action( 'init', 'insprvw_create_movie_review', 0 );