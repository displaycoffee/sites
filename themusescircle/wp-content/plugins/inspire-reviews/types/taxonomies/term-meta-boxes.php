<?php
    ...
    class INSPRVW_Term_Meta_Box {	
		...
		function add_meta() {
            ...
            foreach ( $this->_termMetaBox['fields'] as $field ) {
                ...
                $opening = '<div class="form-field ' . $field['id'] . '-wrap insprvw-term-meta">';
                ...
                insprvw_display_fields( $field, $value );
                ...
                if ( $field['type'] == 'multitext' ) {
                    ...
                    foreach ( $field['options'] as $option ) {
                        ...
                        insprvw_display_multitext( $field, $option, $value );
                    }
                    echo '</div>';                    
                }
                ...
                if ( $field['type'] == 'multicheck' ) {
                    ...
                    foreach ( $field['options'] as $option ) {
                        ...
                        insprvw_display_multicheck( $field, $option, $checked );
                    }
                    echo '</div>';
                }
		...
		function edit_meta( $term ) {
		    ...
		    foreach ( $this->_termMetaBox['fields'] as $field ) {		    
	            // Create opening HTML block
	            $opening = '<tr class="form-field ' . $field['id'] . '-wrap insprvw-term-meta">';
    ...
    foreach ( $termMetaBoxes as $termMetaBox ) {
        new INSPRVW_Term_Meta_Box( $termMetaBox );
    }