...
<div id="front-page-sections">
	<?php 
		...
		$about_section .= $about_left ? wpautop( esc_textarea ( $about_left ) ) : __( '<p>Welcome to our site! We\'re just getting started, but be sure to check back for more information soon.</p>', 'musescircle' );
		$about_section .= '</div>';
