	...
	*/	
	...
	function musescircle_customizer_section( $wp_customize ) {
	    ...
	    $wp_customize->add_section(
	        'musescircle_social',
	        array(
	            'title'		  => __( 'Social Media', 'musescircle' ),
	            'description' => __( 'Add links for website social media.', 'musescircle' )
	        )
	    );

	    // Social Media - Facebook
		$wp_customize->add_setting(
		    'musescircle_facebook',
		    array(
		    	'default'			   => __( 'http://www.facebook.com', 'musescircle' ),
		        'sanitize_callback'	   => 'esc_url',
		        'sanitize_js_callback' => 'esc_url'
		    )
		);
		$wp_customize->add_control(
		    'musescircle_facebook',
		    array(
		        'label'	  => __( 'Facebook', 'musescircle' ),
		        'section' => 'musescircle_social',
		        'type'	  => 'url'
		    )
		);		
		...
		$wp_customize->add_setting(
		    'musescircle_gplus',
		    array(
		    	'default'			   => __( 'http://www.google.com', 'musescircle' ),
		        'sanitize_callback'	   => 'esc_url',
		        'sanitize_js_callback' => 'esc_url'
		    )
		);
		...
		$wp_customize->add_setting(
		    'musescircle_youtube',
		    array(
		    	'default'			   => __( 'http://www.youtube.com', 'musescircle' ),
		        'sanitize_callback'	   => 'esc_url',
		        'sanitize_js_callback' => 'esc_url'
		    )
		);
		...
		$wp_customize->add_setting(
		    'musescircle_twitter',
		    array(
		    	'default'			   => __( 'http://www.twitter.com', 'musescircle' ),
		        'sanitize_callback'	   => 'esc_url',
		        'sanitize_js_callback' => 'esc_url'
		    )
		);
		...
		$wp_customize->add_setting(
		    'musescircle_goodreads',
		    array(
		    	'default'			   => __( 'http://www.goodreads.com', 'musescircle' ),
		        'sanitize_callback'	   => 'esc_url',
		        'sanitize_js_callback' => 'esc_url'
		    )
		);
		$wp_customize->add_control(
		    'musescircle_goodreads',
		    array(
		        'label'	  => __( 'Goodreads', 'musescircle' ),
		        'section' => 'musescircle_social',
		        'type'	  => 'url'
		    )
		);	
		...
		$wp_customize->add_setting(
		    'musescircle_librarything',
		    array(
		    	'default'			   => __( 'http://www.librarything.com', 'musescircle' ),
		        'sanitize_callback'	   => 'esc_url',
		        'sanitize_js_callback' => 'esc_url'
		    )
		);
		$wp_customize->add_control(
		    'musescircle_librarything',
		    array(
		        'label'	  => __( 'Library Thing', 'musescircle' ),
		        'section' => 'musescircle_social',
		        'type'	  => 'url'
		    )
		);											
