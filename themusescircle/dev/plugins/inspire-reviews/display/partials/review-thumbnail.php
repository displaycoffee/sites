...
<?php 	
	...
	if ( has_post_thumbnail() ) {
		...
		// Create thumbnail block
		$thumbnail_html = '<div class="entry-thumbnail" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">';	
		$thumbnail_html .= '<meta itemprop="url" content="' . esc_url ( plugins_url( 'inspire-reviews/assets/images/default-image.svg#default-image-rectangle', '' ) ) . '">';
		$thumbnail_html .= '<div class="image-wrap default-image">';
		$thumbnail_html .= '<svg viewBox="0 0 400 600"><use xlink:href="' . plugins_url( 'inspire-reviews/assets/images/default-image.svg#default-image-rectangle', '' ) . '"></use></svg>';
