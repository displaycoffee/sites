...
<div class="entry-author">
	<?php
		...
		if ( !is_author() ) { 	
			echo '<h3>' . __( 'About', 'themusescircle' ) . ' ' . $author_name . '</h3>';
		}
	?>
	<?php 
	...
	<?php 
		...
		$author_social_links .= $author_tumblr ? '<li>' . insprvw_create_link( 'goodreads', $author_pinterest, 'Goodreads' ) . '</li>' : '';
		$author_social_links .= $author_goodreads ? '<li>' . insprvw_create_link( 'tumblr', $author_pinterest, 'Tumblr' ) . '</li>' : '';
