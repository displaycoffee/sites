<?php
	...
	// Creates a category
	function insprvw_create_book_category() {
		$labels = array(
			'name'              => __( 'Book Categories', 'inspire-reviews' ),
		...
		register_taxonomy( 'insprvw-book-category', 'insprvw-book-review', $args );
	}
	add_action( 'init', 'insprvw_create_book_category', 3 );