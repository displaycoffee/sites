<?php
	...
	function insprvw_create_book_review() {
		$labels = array(
			'name'               => __( 'Book Reviews', 'inspire-reviews' ),
			'singular_name'      => __( 'Book Review', 'inspire-reviews' ),
			...
			'menu_name'          => __( 'Book Reviews', 'inspire-reviews' ),
			'update_item'        => __( 'Update Reviews', 'inspire-reviews' )
		);

		$args = array(
			'label'               => __( 'Book Review', 'inspire-reviews' ),
			'labels'              => $labels,
		...
		register_post_type( 'insprvw-book-review', $args );
	}

	add_action( 'init', 'insprvw_create_book_review', 0 );